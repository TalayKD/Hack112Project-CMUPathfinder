...
to another name or delete nodes txt before running the factory.py file. After running the factory.py file, follow the instructions on the screen to manually input your own nodes.